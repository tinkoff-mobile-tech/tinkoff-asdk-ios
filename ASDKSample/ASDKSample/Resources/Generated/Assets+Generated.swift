...
internal enum Asset {
  ...
  internal enum Icons {
    ...
    internal static let editing = ImageAsset(name: "editing")
  }
  internal static let logoSbp = ImageAsset(name: "logo_sbp")
  internal static let logoTinkoff = ImageAsset(name: "logo_tinkoff")
}
