...
final class YandexPayButtonTestsRU: BaseTestCase {

    // MARK: - Tests

    func test_snapshot_yandexPayButton() throws {
        allureId(2406333, "Отображение кнопки YP в ru локализации")
        ...
        // when
        let result = try XCTUnwrap(try YandexPayHelper.getYandexPayButtons(locale: .ru))
        // then
