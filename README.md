...
pod 'ASDKUI'
```
Если вы не используете Cocoa Pods, необходимо добавить _**ASDKUI.xcodeproj**_ в проект.
...
* **logger** - Интерфейс для логирование работы, есть реализация по умолчанию _**ASDKApiLoggerDelegate**_ форматированный вывод данных о работе SDK в консоль
...
Для проведения оплаты в модуле _**ASDKUI/AcquiringUISDK**_ реализованы методы для сценрия оплаты. Доступны:
...
* **orderId:**_**Int64**_. Номер заказа в системе Продавца;
