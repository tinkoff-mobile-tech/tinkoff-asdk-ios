...
extension UINavigationController {
    static func withElevationBar(rootViewController: UIViewController? = nil) -> UINavigationController {
    ...
    static func withTransparentBar(rootViewController: UIViewController? = nil) -> UINavigationController {
        let navigationController = rootViewController.map(UINavigationController.init) ?? UINavigationController()
