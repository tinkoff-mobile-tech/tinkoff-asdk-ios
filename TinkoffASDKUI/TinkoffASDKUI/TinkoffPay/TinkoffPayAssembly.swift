...
final class TinkoffPayAssembly {
    ...
    func paymentPollingViewController(
        content: TinkoffPayPaymentViewController,
        configuration: AcquiringViewConfiguration,
        completionHandler: PaymentCompletionHandler?
    ) -> PaymentPollingViewController<TinkoffPayPaymentViewController> {
        PaymentPollingViewController(
    ...
    func tinkoffPayPaymentViewController(
    ...
    ) -> TinkoffPayPaymentViewController {
        TinkoffPayPaymentViewController(
            acquiringPaymentStageConfiguration: acquiringPaymentStageConfiguration,
            paymentService: paymentService,
    ...
    var tinkoffPayController: TinkoffPayController {
        if let cachedTinkoffPayController = cachedTinkoffPayController {
            ...
            cachedTinkoffPayController = tinkoffPayController
