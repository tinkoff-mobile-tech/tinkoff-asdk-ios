...
final class SBPAssembly {
    ...
    func paymentPollingViewController(
        content: SBPBankListViewController,
        configuration: AcquiringViewConfiguration,
        completionHandler: PaymentCompletionHandler?
    ) -> PaymentPollingViewController<SBPBankListViewController> {
        let paymentPollingViewController = PaymentPollingViewController(
    ...
    func noAvailableBanksViewController(
