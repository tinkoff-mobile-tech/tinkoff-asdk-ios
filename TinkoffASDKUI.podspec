Pod::Spec.new do |spec|
	...
	test_spec.source_files = 'TinkoffASDKUI/TinkoffASDKUITests/**/*', 'TinkoffASDKCore/TinkoffASDKCoreTests/Infrastructure/Resources/**/*', 'TinkoffASDKCore/TinkoffASDKCoreTests/Infrastructure/Mocks/**/*'
	end
end
